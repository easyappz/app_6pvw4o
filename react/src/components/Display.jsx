...
const Display = ({ value, secondary }) => {
  return (
    <div className="flex flex-col gap-1" data-easytag="id1-react/src/components/Display.jsx">
      <div
        className="text-slate-400 text-sm min-h-5 text-right truncate"
      ...
      <div
        className="text-right text-4xl md:text-5xl font-semibold tracking-tight text-slate-900 select-none"
        aria-live="polite"
        aria-atomic="true"
